					...
					<article class="h-full bg-tile-500 border-2 border-tile-600 rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-tile-500">
						...
						<div class="p-6">
							...
							<p class="text-text-200 leading-relaxed mb-4">
								Practice typing Arabic letters using our virtual keyboard. Get instant audio feedback and real-time spell checking.
							</p>
				...
				<a href="/alphabet/practice/handwriting" class="group">
					<article class="h-full bg-tile-500 border-2 border-tile-600 rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-tile-500">
						...
						<div class="h-40 bg-tile-400 border-b border-tile-600 flex items-center justify-center">
							<div class="relative">
								...
								<svg class="absolute inset-0 w-24 h-24" viewBox="0 0 100 100">
									<path d="M20,60 Q50,30 80,60" stroke="currentColor" stroke-width="3" fill="none" class="text-text-300 group-hover:animate-pulse"/>
								</svg>
							</div>
						</div>
						...
						<div class="p-6">
							...
							<p class="text-text-200 leading-relaxed mb-4">
								Draw letters freehand on a digital canvas. Perfect for learning proper stroke order and letter formation.
							</p>
		...
		<div class="max-w-4xl mx-auto px-4 sm:px-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
				...
				<article class="bg-tile-400 border-2 border-tile-600 rounded-lg p-5 shadow-lg">
					...
					<p class="text-text-200 text-sm leading-relaxed">
						Always listen to pronunciation while writing to reinforce sound-letter associations.
					</p>
				</article>
				...
				<article class="bg-tile-400 border-2 border-tile-600 rounded-lg p-5 shadow-lg">
					...
					<p class="text-text-200 text-sm leading-relaxed">
						Combine keyboard and handwriting practice for the best retention and muscle memory.
					</p>
				</article>
			</div>
		</div>
