			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
				<article class="bg-tile-400 border-2 border-tile-600 rounded-lg p-6 shadow-lg text-center">
					...
					<p class="text-text-200 leading-relaxed">
						Reading and writing are essential skills. Mastering the alphabet opens doors to understanding authentic Arabic content.
					</p>
				</article>
				...
				<article class="bg-tile-400 border-2 border-tile-600 rounded-lg p-6 shadow-lg text-center">
					...
					<p class="text-text-200 leading-relaxed">
						Arabic letters change form based on position. Understanding these patterns helps you read faster and more naturally.
					</p>
				</article>
				...
				<article class="bg-tile-400 border-2 border-tile-600 rounded-lg p-6 shadow-lg text-center">
					...
					<p class="text-text-200 leading-relaxed">
						The Arabic script is shared across all dialects. Learn it once and you can read Egyptian, Levantine, Gulf, and MSA.
					</p>
				</article>
			</div>
		</div>
