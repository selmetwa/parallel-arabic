...
<section class="mx-auto max-w-3xl px-5 pb-36 pt-8">
	<header class="mb-9">
		...
		<p class="hero-sub">
			Free Arabic vocabulary games in Egyptian Arabic, Levantine, Moroccan Darija and Modern
			Standard Arabic. Pick a dialect and a topic, choose whether you want to read, listen or speak,
			and play. Nothing to install, and your progress is saved so you can pick a game back up where
			you left it.
		</p>
	</header>
	...
	<section class="mt-14 block">
		<h2 class="section-title">The game modes</h2>
