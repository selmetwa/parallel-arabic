...
export const load = async ({ locals, parent }) => {
  ...
  // Count stories generated by this user
  ...
  try {
    const { count } = await supabase
      ...
      .eq('user_id', userId);
    storiesGenerated = count ?? 0;
  } catch (e) {
    console.error('Error counting generated stories:', e);
  }
  ...
  try {
    ...
    console.error('Error counting completed games:', e);
  }
