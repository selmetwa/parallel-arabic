...
<section class="px-3 mt-6 sm:px-8 max-w-5xl mx-auto">
	<div class="text-left mb-6">
		<h1 class="text-3xl sm:text-4xl text-text-300 font-bold mb-1 tracking-tight">Fusha Vocabulary Builder</h1>
		<p class="text-text-200 text-lg sm:text-xl leading-snug">
			Practice Modern Standard Arabic vocabulary with fun multiple choice quizzes.
		</p>
