...
<section class="flex flex-col sm:flex-row gap-4 px-4 sm:px-20 pt-4 sm:mt-12">
  ...
  <div class="flex-1 p-2 border border-tile-500 bg-tile-300">
    <h2 class="text-xl font-semibold text-text-300">Join Parallel Arabic</h2>
    <p class="text-text-200 mt-2">Start your Arabic learning journey today!</p>
    <ul class="list-disc list-inside text-text-200 mt-4 space-y-2">
      <li>Access to multiple Arabic dialects</li>
      <li>Interactive stories and exercises</li>
      <li>Voice recognition practice</li>
      <li>Track your progress</li>
      <li>Save words and phrases</li>
    </ul>
  </div>
</section>
