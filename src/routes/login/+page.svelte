  ...
  >
    ...
    <div class="mt-1">
      <a 
        ...
        class="w-full transition-all duration-300 flex items-center justify-center gap-2 bg-tile-500 text-text-300 px-4 py-1 font-semibold border border-tile-600 hover:bg-tile-600"
      >
