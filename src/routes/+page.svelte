...
<section class="px-3 mt-6 sm:px-8 max-w-5xl mx-auto">
  ...
  <div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <!-- Iraqi Arabic -->
      <a href="/iraqi" class="group px-4 py-6 flex-col flex gap-2 border-2 border-tile-600 text-left bg-tile-400 hover:bg-tile-500 hover:border-tile-500 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-1 transform">
        <h3 class="text-xl text-text-300 font-bold group-hover:text-text-200 transition-colors duration-300">Iraqi Arabic</h3>
        <p class="text-text-300 text-sm font-medium leading-tight opacity-90 group-hover:opacity-100 transition-opacity duration-300">
  ...
  <div class="mb-8">
    <h2 class="text-2xl text-text-300 font-bold mb-4">Shared Resources</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <a href="/alphabet" class="group px-4 py-4 flex-col flex gap-2 border-2 border-tile-600 text-left bg-tile-400 hover:bg-tile-500 hover:border-tile-500 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-1 transform">
        <h3 class="text-xl text-text-300 font-bold group-hover:text-text-200 transition-colors duration-300">Arabic Alphabet</h3>
        <p class="text-text-300 text-sm font-medium leading-tight opacity-90 group-hover:opacity-100 transition-opacity duration-300">
          Learn the 28 letters and their connections. Essential foundation for all Arabic dialects.
        </p>
      </a>
    </div>
  </div>
