const arabic = [
  { speaker: "جورج", text: "مساء الخير", audio: '/audio/at-the-hotel/sentence-audio/1.wav' },
  { speaker: "موظف الاستقبال", text: "مساء الخير يا فندم، أقدر أساعد حضرتك إزاي", audio: '/audio/at-the-hotel/sentence-audio/2.wav' },
  { speaker: "جورج", text: "لو سمحت أنا عايز أوضة لشخص واحد، هقعد ٣ أيام", audio: '/audio/at-the-hotel/sentence-audio/3.wav' },
  { speaker: "موظف الاستقبال", text: "تمام يا فندم، ممكن تملأ بيانات حضرتك في الورقة دي وتديني بطاقتك الشخصية أو الباسبور؟", audio: '/audio/at-the-hotel/sentence-audio/4.wav' },
  { speaker: "جورج", text: "تمام، اتفضل", audio: '/audio/at-the-hotel/sentence-audio/5.wav' },
  { speaker: "فيليبس", text: "جورج؟!", audio: '/audio/at-the-hotel/sentence-audio/6.wav' },
  { speaker: "جورج", text: "ايه ده، فيليبس! بتعمل ايه هنا؟", audio: '/audio/at-the-hotel/sentence-audio/7.wav' },
  { speaker: "فيليبس", text: "(يضحك) أنا قاعد في الفندق هنا الفترة دي. هي سيلڨيا اقترحت عليك الفندق ده ولا ايه؟", audio: '/audio/at-the-hotel/sentence-audio/8.wav' },
  { speaker: "جورج", text: "مظبوط، هي فعلًا قالتلي إنه مكان جميل ونضيف وإني هلاقي فيه كل حاجة، بس مقالتليش إني هلاقيك هنا!", audio: '/audio/at-the-hotel/sentence-audio/9.wav' },
  { speaker: "فيليبس", text: "(يضحك بشدة) لو سمحت ممكن تخلي مستر جورج يقعد في نفس الدور بتاعي، أنا في أوضة ۲۱۱", audio: '/audio/at-the-hotel/sentence-audio/10.wav' },
  { speaker: "موظف الاستقبال", text: "حاضر يا فندم، حضرتك سعر الأوضة لفرد واحد ١٨٠٠ جنيه في اليوم", audio: '/audio/at-the-hotel/sentence-audio/11.wav' },
  { speaker: "جورج", text: "تمام، ممكن أدفع بالڨيزا؟", audio: '/audio/at-the-hotel/sentence-audio/12.wav' },
  { speaker: "موظف الاستقبال", text: "أيوه يا فندم، احنا بنقبل الدفع بالڨيزا", audio: '/audio/at-the-hotel/sentence-audio/13.wav' },
  { speaker: "جورج", text: "اتفضل، امتى ممكن آخد الأوضة؟", audio: '/audio/at-the-hotel/sentence-audio/14.wav' },
  { speaker: "موظف الاستقبال", text: "حضرتك استريح في الريسيبشن، دقيقتين والعامل هييجي يآخد منك الشنطة ويطلَّعَك الأوضة", audio: '/audio/at-the-hotel/sentence-audio/15.wav' },
  { speaker: "جورج", text: "شكرًا", audio: '/audio/at-the-hotel/sentence-audio/16.wav' },
  { speaker: "فيليبس", text: "تعالى نقضي السهرة مع بعض بقى، سنتين مشوفكش معقولة؟!", audio: '/audio/at-the-hotel/sentence-audio/17.wav' },
  { speaker: "جورج", text: "طب خليني أطلع أنام ساعة وأنزلك عشان جسمي مكسر ومرهق أوي", audio: '/audio/at-the-hotel/sentence-audio/18.wav' },
  { speaker: "فيليبس", text: "ماشي، هو أنا كنت هروح مع صاحبتي أتمشى شوية وكنا هنيجي هنا بليل عشان بكرة الصبح هنتحرك في جروب .. هنروح الأهرامات" , audio: '/audio/at-the-hotel/sentence-audio/19.wav' },
  { speaker: "جورج", text: "طب حلو أوي أنا هآجي معاكم، الساعة كام بكرة؟", audio: '/audio/at-the-hotel/sentence-audio/20.wav' },
  { speaker: "فيليبس", text: "١٠ هنتحرك", audio: '/audio/at-the-hotel/sentence-audio/21.wav' },
  { speaker: "جورج", text: "حلو", audio: '/audio/at-the-hotel/sentence-audio/22.wav' },
  { speaker: "فيليبس", text: "اطلع ريّح ومستنيك لما تصحى تكلمني بقى", audio: '/audio/at-the-hotel/sentence-audio/23.wav' },
  { speaker: "عامل الفندق", text: "حضرتك أول مرة تزور مصر", audio: '/audio/at-the-hotel/sentence-audio/24.wav' },
  { speaker: "فيليبس", text: "أنا عايش هنا أصلاً بس واخد يومين اجازة أرَوَّق على نفسي", audio: '/audio/at-the-hotel/sentence-audio/25.wav' },
  { speaker: "عامل الفندق", text: "نورت يا أفندم", audio: '/audio/at-the-hotel/sentence-audio/26.wav' },
  { speaker: "فيليبس", text: "ده نورك .. هو  مش الأوضة دي بتبص على النيل برضه؟", audio: '/audio/at-the-hotel/sentence-audio/27.wav' },
  { speaker: "عامل الفندق", text: "مظبوط يا أفندم .. دي واحدة من أحسن الأوض اللي في الفندق", audio: '/audio/at-the-hotel/sentence-audio/28.wav' },
  { speaker: "عامل الفندق", text: "اتفضل مستر جورج .. فيه هنا تلفزيون، تلاجة، والحمام من هنا .. باسوورد الواي فاي على الورقة إللي فيها إرشادات الفندق إللي على الترابيزة دي", audio: '/audio/at-the-hotel/sentence-audio/29.wav' },
  { speaker: "جورج", text: "شكرًا بجد", audio: '/audio/at-the-hotel/sentence-audio/30.wav' },
  { speaker: "عامل الفندق", text: "التليفون كمان هنا، لو احتجت أي حاجة ممكن تكلم الريسيبشن", audio: '/audio/at-the-hotel/sentence-audio/31.wav' },
  { speaker: "جورج", text: "شكرًا، هو صحيح المطعم نظامه ايه، أنا نسيت أسأل تحت", audio: '/audio/at-the-hotel/sentence-audio/32.wav' },
  { speaker: "عامل الفندق", text: "حضرتك فيه وجبتين مجانًا من ضمن خدمات الإقامة بالفندق: الفطار من الساعة ٩ لحد ١١. والغداء من الساعة ٢ لحد الساعة ٥.. المطعم بيبقى أوبن بوفيه وممكن حضرتك تآكل اللي انت عايزه، بس لو بتفضل أكل معين تقدر تطلبه من الشيف المطعم", audio: '/audio/at-the-hotel/sentence-audio/33.wav' },
  { speaker: "جورج", text: "جميل أوي شكرًا", audio: '/audio/at-the-hotel/sentence-audio/34.wav' },
  { speaker: "عامل الفندق", text: "العفو، أي خدمة تانية؟", audio: '/audio/at-the-hotel/sentence-audio/35.wav' },
  { speaker: "جورج", text: "آه ياريت بس تشغل التلفزيون عشان عايز أشوف فيه قنوات ايه؟", audio: '/audio/at-the-hotel/sentence-audio/36.wav' },
  { speaker: "عامل الفندق", text: "أهو .. الزرار اللي على الشمال ده هو اللي بيفتح ال", audio: '/audio/at-the-hotel/sentence-audio/37.wav' },
  { speaker: "جورج", text: "تمام حلو أوي ..  (يعطي العامل بقشيش) اتفضل دي حاجة بسيطة علشانك" },
  { speaker: "عامل الفندق", text: "ملوش داعي التعب يا أفندم", audio: '/audio/at-the-hotel/sentence-audio/40.wav' },
  { speaker: "جورج", text: "لا معلش", audio: '/audio/at-the-hotel/sentence-audio/41.wav' },
  { speaker: "عامل الفندق", text: "شكراً لذوقك .. مع السلامة يا أفندم", audio: '/audio/at-the-hotel/sentence-audio/42.wav' },
  { speaker: "جورج", text: "مع السلامة", audio: '/audio/at-the-hotel/sentence-audio/43.wav' }
];
