export type XpEventType = 'review_cycle' | 'review_correct' | 'sentence_correct' | 'story_complete' | 'lesson_complete' | 'game_correct' | 'challenge_bonus' | 'conjugation_correct' | 'word_of_day_save';
