...
<div class="relative inline-block text-left">
  <div>
    <button on:click={toggleDropdown} class="dropdown-button inline-flex justify-center w-full rounded-full border bg-tile-400 border-gray-300 shadow-sm p-2 text-sm font-medium text-text-300 hover:bg-tile-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tile-600">
