export const story = {
  ...
  keyWords: [
    ...
    "جِيرَان= Neighbours = Ger",
    "أغَاني= Songs = Aghany",
    "بَوَّابة =Gate = Bawaba",
    "أرْقَام =Numbers = Arqam",
    "حُرُوف= Letters = 7orouf",
    "قِصَصَ= Stories = Qesas",
    "فُسْحَة= Recess = Fos7a",
    "وَاجِب =Homework = Wageb",
    "ألْعَاب = Games = Al3ab",
    "مُغَامَرَات= Adventures = Moghamarat"
  ]
}
